...
int usage(std::ostream& to = std::cerr) {
  to <<
      ...
      "  --read-record          carry the paths already read into a rebuilt window. Off by\n"
      "                         default: it did not stop a model re-reading them in the one\n"
      "                         paired run so far, and it makes rebuilds fire less often\n"
